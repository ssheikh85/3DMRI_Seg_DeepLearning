...
class UNetExperiment:
    ...
    def train(self):
        ...
        for i, batch in enumerate(self.train_loader):
            ...
            # ANSWER:
            '''The first dimension represents the number of input channels, the second dimension the number of                     output channels, the third dimension the number of classes, the fourth dimension the kernel size'''
